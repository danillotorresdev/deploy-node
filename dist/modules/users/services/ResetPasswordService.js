...
let ResetPasswordService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const tokenCreatedAt = userToken.created_at; // adiciona 2 horas no tokenCreatedAt

    const compareDate = (0, _dateFns.addHours)(tokenCreatedAt, 2); // compara se a já passou do horário limite de 2 horas
