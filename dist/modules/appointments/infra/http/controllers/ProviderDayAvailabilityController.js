...
class ProviderDayAvailabilityController {
  async index(request, response) {
    ...
    const listProviderDayAvailability = _tsyringe.container.resolve(_ListProviderDayAvailabilityService.default); // service sendo executado passando os dados que ele precisa
