...
class ProviderMonthAvailabilityController {
  async index(request, response) {
    ...
    const listProviderMonthAvailability = _tsyringe.container.resolve(_ListProviderMonthAvailabilityService.default); // service sendo executado passando os dados que ele precisa
